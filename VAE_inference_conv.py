...
from vox_encoder.vae_cnn import VAE_CNN
...
def main():
    ...
    # Paths
    checkpoint_path = Path(MODEL_LATEST_DIR, "AE_checkpoint_conv_vae.pth")
    ...
    evaluator = Evaluate.load_conv(checkpoint_path, model=VAE_CNN(latent_dim, output_dim))
    ...
    # Run inference
    raw_output, thresholded_output, latent, mu, logvar, accuracy = evaluator.inference_vae_cnn(
        input_tensor
    )
